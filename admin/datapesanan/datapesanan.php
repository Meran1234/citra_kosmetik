    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="tambahpesanan.php?aksi=tambah" class="btn btn-primary">+ Tambah Data</a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="produkTable">
                            ...
                            <tbody>
                                ...
                                if ($search) {
                                    $query = "SELECT * FROM tbl_pesanan WHERE nama LIKE '%$search%'";
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($a['id_pesanan']); ?></td>
                                        <td><?php echo htmlspecialchars($a['nama']); ?></td>
                                        <td><?php echo htmlspecialchars($a['produk']); ?></td>
                                        <td><?php echo htmlspecialchars($a['harga']); ?></td>
                                        <td><?php echo htmlspecialchars($a['metode_pembayaran']); ?></td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="editpesanan.php?id_pesanan=<?php echo urlencode($a['id_pesanan']); ?>&aksi=ubah" style="display: inline-block; margin: 0 5px; font-size: 12px;">
                                                <i class="bi bi-pencil-square" style="margin-left: 5px;"></i>
                                            </a>
                                            <a href="prosespesanan.php?id_pesanan=<?php echo urlencode($a['id_pesanan']); ?>&proses=proseshapus"
