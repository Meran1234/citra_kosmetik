                    ...
                    <div class="table-responsive">
                        <table id="produkTable">
                            ...
                            <tbody>
                                ...
                                if ($search) {
                                    $query = "SELECT * FROM tbl_pembeli WHERE nama LIKE '%$search%'";
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($a['id_pembeli']); ?></td>
                                        ...
                                        <td><?php echo htmlspecialchars($a['no_telp']); ?></td>
                                        <td><?php echo htmlspecialchars($a['id_alamat']); ?></td>
                                        <td><img src="../../profil/<?php echo htmlspecialchars($a['gambar']); ?>" width="100"></td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="editpembeli.php?id_pembeli=<?php echo urlencode($a['id_pembeli']); ?>&aksi=ubah" style="display: inline-block; margin: 0 5px; font-size: 12px;">
                                                <i class="bi bi-pencil-square" style="margin-left: 5px;"></i>
                                            </a>
                                            <a href="prosespembeli.php?id_pembeli=<?php echo urlencode($a['id_pembeli']); ?>&proses=proseshapus"
