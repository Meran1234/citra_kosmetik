    ...
    <div class="container">
        <div class="d-flex justify-content-between d-f" style="margin-top: 10px;">
            ...
            <form method="GET" action="" class="d-flex">
                <input type="text" name="search" class="form-control" value="<?php echo htmlspecialchars($search); ?>" placeholder="Cari nama admin..."
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="tambahadmin.php?aksi=tambah" class="btn btn-primary">+ Tambah Data</a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="produkTable">
                            ...
                            <tbody>
                                ...
                                if ($search) {
                                    $query = "SELECT * FROM tbl_admin WHERE nama LIKE '%$search%'";
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($a['id_admin']); ?></td>
                                        <td><?php echo htmlspecialchars($a['nama']); ?></td>
                                        <td><?php echo htmlspecialchars($a['email']); ?></td>
                                        <td><?php echo htmlspecialchars($a['password']); ?></td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="editadmin.php?id_admin=<?php echo urlencode($a['id_admin']); ?>&aksi=ubah" style="display: inline-block; margin: 0 5px; font-size: 12px;">
                                                <i class="bi bi-pencil-square" style="margin-left: 5px;"></i>
                                            </a>
                                            <a href="prosesadmin.php?id_admin=<?php echo urlencode($a['id_admin']); ?>&proses=proseshapus"
