    ...
    <div class="container">
        <div class="d-flex justify-content-between d-f" style="margin-top: 10px;">
            ...
            <form method="GET" action="" class="d-flex">
                <input type="text" name="search" class="form-control" value="<?php echo htmlspecialchars($search); ?>" placeholder="Cari merek produk..."
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="tambahproduk.php?aksi=tambah" class="btn btn-primary">+ Tambah Data</a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="produkTable">
                            ...
                            <tbody>
                                ...
                                if ($search) {
                                    $query = "SELECT * FROM tbl_produk WHERE merek LIKE '%$search%'";
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($a['id_produk']); ?></td>
                                        <td><?php echo htmlspecialchars($a['kategori']); ?></td>
                                        <td><?php echo htmlspecialchars($a['jenis']); ?></td>
                                        <td><?php echo htmlspecialchars($a['merek']); ?></td>
                                        <td><?php echo htmlspecialchars($a['deskripsi']); ?></td>
                                        <td><?php echo htmlspecialchars(number_format($a['harga'], 0, ',', '.'), ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?php echo htmlspecialchars($a['stok']); ?></td>
                                        <td><?php
                                            $gambarArray = explode(',', $a['gambar']);
                                            foreach ($gambarArray as $gambar) {
                                                echo '<img src="../../uploads/' . htmlspecialchars($gambar) . '" width="80" style="margin:3px; border-radius:4px;">';
                                            }
                                            ?>
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="editproduk.php?id_produk=<?php echo urlencode($a['id_produk']); ?>&aksi=ubah" style="display: inline-block; margin: 0 5px; font-size: 12px;">
                                                <i class="bi bi-pencil-square" style="margin-left: 5px;"></i>
                                            </a>
                                            <a href="prosesproduk.php?id_produk=<?php echo urlencode($a['id_produk']); ?>&proses=proseshapus"
