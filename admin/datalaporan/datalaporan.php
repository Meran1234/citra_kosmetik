    ...
    <div class="container">
        <div class="d-flex justify-content-between d-f" style="margin-top: 10px;">
            ...
            <form method="GET" action="" class="d-flex">
                <input type="text" name="search" class="form-control" value="<?php echo htmlspecialchars($search); ?>" placeholder="Cari nama merek..."
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="tambahlaporan.php?aksi=tambah" class="btn btn-primary">+ Tambah Data</a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table id="produkTable">
                            ...
                            <tbody>
                                ...
                                if ($search) {
                                    $query = "SELECT * FROM tbl_laporan WHERE merek LIKE '%$search%'";
                                } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($a['id_laporan']); ?></td>
                                        <td><?php echo htmlspecialchars($a['rentang_waktu']) . " bulan"; ?></td>
                                        <td><?php echo htmlspecialchars(number_format($a['total'], 0, ',', '.'), ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?php echo htmlspecialchars($a['merek']); ?></td>
                                        <td><?php echo htmlspecialchars(number_format($a['keuntungan'], 0, ',', '.'), ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            <a href="editlaporan.php?id_laporan=<?php echo urlencode($a['id_laporan']); ?>&aksi=ubah" style="display: inline-block; margin: 0 5px; font-size: 12px;">
                                                <i class="bi bi-pencil-square" style="margin-left: 5px;"></i>
                                            </a>
                                            <a href="proseslaporan.php?id_laporan=<?php echo urlencode($a['id_laporan']); ?>&proses=proseshapus"
